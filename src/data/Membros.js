...
export const membros = [
    {
      ...
      curriculo: `
        ...
        Para conhecer um pouco mais de Marcos Saes, é só acessar o seu linkedin. Se quiser manter contato, ligue para uma de nossas sedes ou mande um e-mail para marcos@saesadvogados.com.br.
      `,
    },
    {
      id: 2,
      nome: 'Gleyse Gulin',
      cargo: 'Advogada | OAB/RJ 172.476',
      imagem: gleyse,
      email: 'gleyse@saesadvogados.com.br',
      linkedin_url: 'https://www.linkedin.com/in/gleyse-gulin/', 
      artigos_url: 'https://www.saesadvogados.com.br/author/gleyse/',
      curriculo: `
        ...
        A advogada está envolvida na coordenação e elaboração de capítulos jurídicos de estudos ambientais, revisões de planos e programas ambientais, na gestão de condicionantes de licenças ambientais, interface com os órgãos envolvidos, elaboração de normativos e manuais de meio ambiente para a melhor integração de sistema de gestão ambiental de empresas, diagnóstico jurídico ambiental de empreendimentos, realização de due diligence e análise de risco. Para Gleyse, “a multidisciplinaridade da área ambiental faz com que o advogado tenha cabeça de advogado com a praticidade e objetividade de um engenheiro. A soma disso faz com que muitos problemas sejam evitados, antes mesmo de que haja necessidade de serem resolvidos. Com essa atuação, a probabilidade de eventuais casualidades ambientais ocorrer é reduzida consideravelmente, dando mais conforto ao cliente”.
        ...
        Para conhecer um pouco mais de Gleyse Gulin, é só acessar o seu linkedin. Se quiser manter contato, ligue para uma de nossas sedes ou mande um e-mail para gleyse@saesadvogados.com.br.
      `,
    },
    {
      id: 3,
      nome: 'Manuela K Hermenegildo Andriani',
      cargo: 'Advogada | OAB/SC 44.175',
      imagem: manuela,
      email: 'manuela@saesadvogados.com.br',
      linkedin_url: 'https://www.linkedin.com/in/manuela-k-hermenegildo-andriani/', 
      artigos_url: 'https://www.saesadvogados.com.br/author/manuela/',
      curriculo: `
        Manuela Kuhnen Hermenegildo Andriani possui dupla formação: é advogada e engenheira. Graduada em Engenharia Sanitária e Ambiental, pela UFSC, desde 2011, e em Direto, pelo CESUSC, desde 2015, destaca-se por aliar o conhecimento técnico ao jurídico.
        Entre os anos de 2012 e 2015 trabalhou no Laboratório de Transporte e Logística - LabTrans da UFSC, em que participou da elaboração de estudos e projetos ambientais relacionados à área de transporte (portos e terminais, transporte ferroviário, transporte rodoviário, transporte aéreo, transporte de passageiros).
        Atualmente, participa da Comissão de Desenvolvimento e Infraestrutura da OAB/SC, é membro da Comissão de Direito Ambiental do Instituto Brasileiro de Direito Imobiliário - Ibradim e também da Câmara Técnica Jurídica do Conselho Municipal de Defesa do Meio Ambiente - COMDEMA/Florianópolis..
        É parte da equipe do Saes Advogados desde 2016 e tem o compromisso de buscar soluções às demandas do escritório apoiada em uma atuação preventiva e especializada. "O Direito me encantou quando verifiquei que é a partir da adequada aplicação da legislação que se obtém a forma mais efetiva de se encarar os problemas existentes em matéria ambiental. Tenho certeza que posso auxiliar não só para resolver os problemas a serem enfrentados, mas também para evitar que os mesmos ocorram".
        Para conhecer um pouco mais de Manuela Hermenegildo, é só acessar o seu linkedin. Se quiser manter contato, ligue para uma de nossas sedes ou mande um e-mail para manuela@saesadvogados.com.br.
      `,
    },
    {
      id: 4,
      nome: 'Isabella Dabrowski Pedrini Hamad',
      cargo: 'Advogada | OAB/SC 39.232',
      imagem: isabella,
      email: 'isabella@saesadvogados.com.br',
      linkedin_url: 'https://www.linkedin.com/in/isabella-dabrowski-pedrini-hamad/', 
      curriculo: `
        Isabella Dabrowski Pedrini Hamad é advogada desde 2014, graduada em Direito pela Universidade do Sul de Santa Catarina (UNISUL). Possui graduação em Administração Empresarial pela Universidade do Estado de Santa Catarina (UDESC) e é Doutora em Administração pela Universidade do Estado de Santa Catarina (UDESC) desde 2022.
        ...
        Participa como pesquisadora do Grupo de Estudos das Transformações Sociais e Organizacionais junto à Universidade do Estado de Santa Catarina (UDESC), onde se dedica ao estudo da gestão das organizações e sustentabilidade. Isabella é coautora de artigos científicos, com destaque para o publicado em 2021 “Environmental liability litigation could remedy biodiversity loss” publicado na Revista Conservation Letters.
        Para conhecer um pouco mais de Isabella Dabrowski, é só acessar seu Linkedin. Se quiser manter contato, ligue para uma de nossas sedes ou mande um e-mail para isabella@saesadvogados.com.br.
      `,
    },
    {
      id: 5,
      nome: 'Camilla Pavan Costa',
      cargo: 'Advogada | OAB/SC 33.200',
      imagem: camilla,
      email: 'camilla.costa@saesadvogados.com.br',
      linkedin_url: 'https://www.linkedin.com/in/camilla-pavan-costa/', 
      curriculo: `
        ...
        Para conhecer um pouco mais de Camilla, é só acessar o seu linkedin. Se quiser manter contato, ligue para uma de nossas sedes ou mande um e-mail para camilla.costa@saesadvogados.com.br.
      `,
    },
    {
      id: 6,
      nome: 'Eduardo dos Anjos Saes',
      cargo: 'Advogado | OAB/SC 70.652',
      imagem: eduardo,
      email: 'eduardo@saesadvogados.com.br',
      linkedin_url: 'https://www.linkedin.com/in/eduardo-dos-anjos-saes/', 
      curriculo: `
        ...
        Para conhecer um pouco mais de Eduardo dos Anjos Saes, é só acessar o seu Linkedin. Se quiser manter contato, ligue para uma de nossas sedes ou mande um e-mail para eduardo@saesadvogados.com.br.
      `,
    },
    {
      id: 7,
      nome: 'Nicole Bittencourt de Freitas Lima',
      cargo: 'Advogada | OAB/SC 73.238',
      imagem: nicole,
      email: 'nicole@saesadvogados.com.br',
      linkedin_url: 'https://www.linkedin.com/in/nicole-bittencourt-de-freitas-lima/', 
      curriculo: `
        ...
        Para conhecer um pouco mais de Nicole Bittencourt de Freitas Lima, é só acessar o seu linkedin. Se quiser manter contato, ligue para uma de nossas sedes ou mande um e-mail para nicole@saesadvogados.com.br.
      `,
    },
    {
      id: 8,
      nome: 'Luiza Neves Alcantara',
      cargo: 'Estagiária',
      imagem: luiza,
      email: 'luiza@saesadvogados.com.br',
      linkedin_url: 'https://www.linkedin.com/in/luiza-neves-alcantara/', 
      curriculo: `
        ...
        Possui experiência como estagiária em órgão público ambiental, assim como integrante do Programa de Voluntariado do ICMBio, na área de Uso Público, auxiliando em atividades relacionadas à gestão em unidades de conservação. Também é técnica em Administração pelo Instituto Federal do Paraná (IFPR), onde teve oportunidade de ser bolsista do Programa Institucional de Bolsas de Iniciação Científica do CNPq.
        Para conhecer um pouco mais de Luiza Alcantara, é só acessar o seu linkedin. Se quiser manter contato, ligue para uma de nossas sedes ou mande um e-mail para luiza@saesadvogados.com.br.
      `,
    },
    {
      id: 9,
      nome: 'Maria Helena Lemos',
      cargo: 'Administradora',
      imagem: maria,
      email: 'mariahelena@saesadvogados.com.br',
      linkedin_url: 'https://www.linkedin.com/in/maria-helena-lemos/', 
      curriculo: `
        ...
        Em agosto de 2015, passou a fazer parte da equipe do Saes Advogados, agregando novos valores e adquirindo experiências, não somente em sua área de atuação, mas também na área do direito ambiental. Helena faz a gestão administrativa de todas as sedes do escritório, atuando na gestão dos contratos e nas atividades financeiras e organizacionais.
        Para conhecer um pouco mais de Maria Helena Lemos, é só acessar o seu linkedin. Se quiser manter contato, ligue para uma de nossas sedes ou mande um e-mail para mariahelena@saesadvogados.com.br.
      `,
    },
    {
      id: 10,
      nome: 'Polliana Muller',
      cargo: 'Auxiliar Administrativa',
      imagem: polliana,
      email: 'polliana@saesadvogados.com.br',
      linkedin_url: 'https://www.linkedin.com/in/polliana-muller/', 
      curriculo: `
        ...
        Para conhecer um pouco mais sobre Polliana Muller, é só acessar o seu Linkedin. Se quiser manter contato, ligue para uma de nossas sedes ou mande um e-mail para polliana@saesadvogados.com.br.
      `,
    },
    {
      id: 11,
      nome: 'Ana Carolina Borduan',
      cargo: 'Recepcionista',
      imagem: ana,
      email: 'anacarolina@saesadvogados.com.br',
      linkedin_url: 'https://www.linkedin.com/in/ana-carolina-borduan/', 
      curriculo: `
        ...
        Para conhecer um pouco mais sobre Ana Carolina Borduan, é só acessar o seu linkedin. Se quiser manter contato, ligue para uma de nossas sedes ou mande um e-mail para anacarolina@saesadvogados.com.br.
      `,
    },
];